...
from .example_suite_intake import ExampleSuiteIntake
...
DEFAULT_AGENT_LIMITS = RunLimits(request_limit=MINER_MAX_REQUESTS_PER_AGENT, output_retries=2)
...
def make_issue_collection_task(
    ...
    *,
    ...
    return _task(
        ...
        context=TaskContext(workspace_root=workspace_root),
        workspace=WorkspacePolicy(
            cwd=workspace_root,
            repository=FileAccess.READ_WRITE,
            allow_network=True,
        ),
...
def make_root_cause_task(
    ...
    *,
    ...
    return _task(
        ...
        workspace=WorkspacePolicy(
            cwd=workspace_root,
            repository=FileAccess.READ_ONLY,
            cases=FileAccess.READ_WRITE,
        ),
